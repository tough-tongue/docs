...
<Check>Monitor API usage and errors</Check>
<Check>Keep dependencies up to date</Check>
...
<CardGroup cols={3}>
  ...
  <Card title="API Playground" icon="flask" href="https://app.toughtongueai.com/api-playground">
