...
<CardGroup cols={2}>
  <Card title="Iframe Embedding" icon="window" href="/developer/iframe">
    Drop-in widget. Fastest integration—under 5 minutes.
  </Card>
  <Card title="REST API" icon="code" href="/developer/api">
...
| Event handling | postMessage       | Webhooks         |
...
- [Starter Templates](/starters/overview) — Working code examples
