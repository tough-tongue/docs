...
<Note>
  **Beta:** This documentation is under active development.
  [Join Discord](https://discord.com/invite/NfTPT3HsSj) for updates.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Docs" icon="code" href="/getting-started/quickstart#for-developers">
    API & iframe integration.
  </Card>
</CardGroup>

<Tip>
  **Ready-to-use:** Browse [Scenario Library](https://app.toughtongueai.com/library)
  with 100+ pre-built agents.
</Tip>
