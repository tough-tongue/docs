...
const STAT_TILES = [
  ...
  { label: "Landscape", value: "The Sanctuary" },
  { label: "Residences", value: "Expansive" },
  { label: "Address", value: "DLF Golf Drive" },
];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1480px] mx-auto px-6 md:px-12 lg:px-16 py-24">
        ...
        >
          A private address for those who already know the city.
        </p>
      </div>

      {STRIPS.map((s, i) => <Strip strip={s} index={i} key={s.line1} />)}
    </section>
  );
};
