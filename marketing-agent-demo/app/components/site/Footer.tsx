...
function DevSection() {
  const { sessionId, connect, disconnect, widgetMode, setWidgetMode } =
    useSession();
  return (
    <div
    ...
    >
      <span className="text-[9px] font-mono uppercase tracking-[0.4em] text-white/25">
        dev
      </span>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-8 font-body text-sm leading-[1.95] opacity-80 max-w-md">
              Private golf-front residences on DLF Golf Drive — the most
              composed chapter after The Aralias and The Magnolias.
            </p>
          </div>

          {/* Explore */}
          <div className="lg:col-span-3">
            <span className="overline" style={{ color: "#C5A059" }}>
              Explore
            </span>
        ...
        <div className="mt-10 pt-8 border-t border-white/15 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-8 text-[13px] tracking-[0.18em] uppercase opacity-70">
            <a
              ...
              className="hover:opacity-100 hover:text-[#C5A059] transition-colors"
            >
              Privacy Policy
            </a>
            <a
